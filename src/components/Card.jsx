...
function Card({ item }) {
  return (
    <div className="my-10 w-[18rem] transition-transform ">
      <div className="card duration-300 ease-in  hover:rotate-3d hover:-rotate-2 hover:scale-110 bg-base-100 w-[18rem] shadow-xl cursor-pointer border-[2px] transform hover:-translate-y-2 hover:shadow-2xl hover:-hue-rotate-180">
